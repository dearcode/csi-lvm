...
import (
	...
	"github.com/dearcode/csi-lvm/pkg/csi-common"
)
...
func (f *flexAdapter) Run(driverName, driverPath, nodeID, endpoint string) {
	...
	f.driver.AddControllerServiceCapabilities([]csi.ControllerServiceCapability_RPC_Type{csi.ControllerServiceCapability_RPC_CREATE_DELETE_VOLUME})
