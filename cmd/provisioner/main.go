...
import (
	...
	ctrl "github.com/dearcode/csi-lvm/pkg/provisioner"
...
var (
	...
	driverName           = flag.String("driver-name", "lvm", "Name of driver.")
...
func init() {
	...
	// the controller
	csiProvisioner := ctrl.NewCSIProvisioner(clientset, csiAPIClient, *csiEndpoint, *connectionTimeout, identity, *volumeNamePrefix, *volumeNameUUIDLength, grpcClient)
	provisionController = controller.NewProvisionController(clientset, *provisioner, csiProvisioner, serverVersion.GitVersion, controller.LeaderElection(*enableLeaderElection))
}
